  ...
  return (
    <Card className="w-[390px] bg-zinc-900 text-zinc-100">
      ...
      <CardFooter className="flex gap-1 pt-3 justify-between">
        <Button onClick={handleDelete} variant="outline" size="icon" className="h-12 w-12 rounded-lg border-zinc-800 bg-transparent text-zinc-400 hover:bg-zinc-800 hover:text-zinc-100">
