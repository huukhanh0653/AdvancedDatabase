...
(
    ...
    MaMon SMALLINT PRIMARY KEY,
    CONSTRAINT FK_THUCDON_CHINHANH
    FOREIGN KEY (MaKV) REFERENCES CHINHANH(MaKV)
);
GO
...
(
	...
	CONSTRAINT FK_PHUCVU_CHINHANH FOREIGN KEY (MaCN) REFERENCES CHINHANH(MaCN),
	CONSTRAINT FK_PHUCVU_MONAN FOREIGN KEY (MAMON) REFERENCES MONAN(MAMON)
);
GO
...
(
    ...
    CONSTRAINT FK_DATBAN_HOADON FOREIGN KEY (MaHoaDon) REFERENCES HoaDon(MaHD),
);
GO
...
--ALTER TABLE PHIEUDATMON 
--DROP CONSTRAINT FK_PHIEUDATMON_BAN
