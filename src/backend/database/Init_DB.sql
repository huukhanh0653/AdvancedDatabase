...
CREATE TABLE THUCDON -- Theo khu vực
(
    MaKV CHAR(2),
    MaMon SMALLINT,

	PRIMARY KEY(MaKV, MaMon)
);
GO

-- Thêm thực đơn cho từng khu vực
...
CREATE TABLE PHUCVU -- Thực đơn của chi nhánh
(
    MaCN CHAR(2),
    MaMon SMALLINT,
...
ALTER TABLE THUCDON
ADD CONSTRAINT FK_THUCDON_KHUVUC
FOREIGN KEY (MaKV) REFERENCES KHUVUC(MaKV);
...
ADD CONSTRAINT FK_PHIEUDATMON_NHANVIEN
FOREIGN KEY (MaNV) REFERENCES NHANVIEN(MaNV),
CONSTRAINT FK_PHIEUDATMON_BAN
FOREIGN KEY (MaBan, MaCN) REFERENCES BAN(MaBan, MaCN),
...
ALTER TABLE DATBAN
ADD CONSTRAINT FK_DATBAN_PHIEUDATMON
FOREIGN KEY (MaPhieu) REFERENCES PHIEUDATMON_TRUOC(MaPhieu),
CONSTRAINT FK_DATBAN_KHUVUC
FOREIGN KEY (MaKV) REFERENCES KHUVUC(MaKV),
CONSTRAINT FK_DATBAN_HOADON 
FOREIGN KEY (MaHD) REFERENCES HoaDon(MaHD),
...
FOREIGN KEY (MaHD) REFERENCES HOADON(MaHD),
CONSTRAINT FK_BAN_CHINHANH
FOREIGN KEY (MaCN) REFERENCES CHINHANH(MaCN);
go

ALTER TABLE PHIEUDATMON_TRUOC
ADD CONSTRAINT FK_PHIEUDATMON_TRUOC_DATBAN 
FOREIGN KEY (MaDatBan) REFERENCES DATBAN(MaDatBan);

ALTER TABLE CHONMON_TRUOC
ADD CONSTRAINT FK_CHONMON_TRUOC_PHIEUDATMON 
FOREIGN KEY (MaPhieu) REFERENCES PHIEUDATMON_TRUOC(MaPhieu),
CONSTRAINT FK_CHONMON_TRUOC_MONAN
FOREIGN KEY (MaMon) REFERENCES MONAN(MaMon);
...
--ALTER SEQUENCE Seq_MaThe RESTART WITH 1;

CREATE OR ALTER TRIGGER trg_InsertMaThe
ON THETHANHVIEN
INSTEAD OF INSERT
AS
BEGIN
    ...
    SELECT 
        RIGHT('000000' + CAST(NEXT VALUE FOR Seq_MaThe AS varchar(6)), 6), -- Generate 6-character MaThe
        NgayLap,
        LoaiThe,
        DiemTichLuy,
        IsActive,
