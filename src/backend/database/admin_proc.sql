...
CREATE PROCEDURE SP_GET_TOTAL_CUSTOMER
AS
BEGIN
...
CREATE PROCEDURE sp_GetTotalRevenueBranch
    @MaCN INT,
    @FromDate DATE,
    @ToDate DATE
AS
...
CREATE PROCEDURE sp_getTotalRevenueCompany
    @sqlFromDate DATE,
    @sqlToDate DATE
AS
BEGIN
...
CREATE PROCEDURE sp_GetDailyRevenueRegion
    @sqlFromDate DATE,
    @sqlToDate DATE,
    @region NVARCHAR(50)
AS
...
CREATE PROCEDURE sp_GetTotalRevenueRegion
    @sqlFromDate DATE,
    @sqlToDate DATE,
    @region NVARCHAR(50)
AS
